...
export class ListenerService{
    ...
    listen(){
        return this.http.get('http://localhost:8085/notificationreceivers/Get?idPlayerReceiverFK='+ this.playerSession.getPlayerInSession().idplayer).pipe(map((res)=> this.ping.next(res)));
