  ...
  onSubmit(form: NgForm) {
    ...
    this.http.post<any>('http://localhost:8085/login', { email: email, password: password },{observe: 'response'}).subscribe(
      resData => {
        ...
        this.player = new Player(resData[0].idplayer, resData[0].idguildFK, resData[0].userName, resData[0].email, resData[0].password, this.getImagePathlog(resData[0].idplayer), resData[0].xp,
