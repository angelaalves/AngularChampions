...
@Component({
    ...
    <div class="scrollmenu" id=style-8>
      <img src="../../../assets/Shoes/ShoesBlack.png" style="width:15%"/>
      <img  src="../../../assets/Shoes/ShoesBrown.png" style="width:15%"/>
      <img  src="../../../assets/Shoes/ShoesWhite.png" style="width:15%">
      </div>
      `,
      styles: [`
      div.scrollmenu {
