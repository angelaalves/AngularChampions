...
export class RewardsComponent implements OnInit {
  ...
  onSubmit(form: NgForm) {
    ...
    this.http.post('http://localhost:8189/rewards/Reward?playerGiver=' + playerGiver + '&playerReceiver=' + playerReceiver + '&time=' + timeSpent + '&justification=' + reason, { playerGiver, playerReceiver, timeSpent, reason }).subscribe(resData => {
      console.log("success")
    }, error => {
